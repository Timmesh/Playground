...
import com.playground.entities.Item;


/**
 * @author USER Group by the name + Count or Sum the Qty..
 * 
 */
public class StreamCollectors3 {
	public static void main(String[] args) {
		...
		Map<String, Integer> sum = items.stream()
				.collect(Collectors.groupingBy(i -> i.getName(), Collectors.summingInt(Item::getQty)));
